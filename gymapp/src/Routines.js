...
export default class Routines extends Component {
  ...
  getRoutines = () => {
    let url = `${SERVER}/gymzoAPI/getAllRoutines?userId=${this.props.user.id}`;
    let settings = {
      method: "GET",
      headers: {
  ...
  deleteRoutine = event => {
    ...
    event.preventDefault();
    let url = `${SERVER}/gymzoAPI/deleteRoutine?routineId=${event.target.value}`;
    let settings = {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json"
      ...
      <div className="body">
        ...
        <div id="myRoutine">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button
                          ...
                          className="setDefaultRoutine"
                          className="btn btn-primary "
                          name="setDefaultRoutine"
                          value={ex._id}
                        >
                          Set Default
                        </button>{" "}
          ...
          <div id="routineButtons">
            ...
            <p>
              {" "}
              <button id="addRoutinebtn" onClick={this.addRoutine}>
                Add Routine
              </button>{" "}
            </p>
          </div>
